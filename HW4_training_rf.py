...
axes[0].set_title(f'Random Forest: Predicted vs Actual (R² = {r2_test:.2f})')
...
axes[1].set_title(f'Random Forest: Residual Distribution (RMSE = {test_rmse:.2f})')
...
fig.text(0.5, 0.01, f"Random Forest - RMSE_validation: {val_rmse:.2f}, RMSE_test: {test_rmse:.2f}, R²: {r2_test:.4f}", ha='center', fontsize=7)
